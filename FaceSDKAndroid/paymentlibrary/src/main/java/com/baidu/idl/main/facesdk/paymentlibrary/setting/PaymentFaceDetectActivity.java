...
public class PaymentFaceDetectActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.qc_save) {
            ...
            PWTextUtils.showDescribeText(linerreCognizeThrehold, tvThreshold,
                    PaymentFaceDetectActivity.this, getString(R.string.cw_recognizethrehold), showWidth, showXLocation);
        }
    }
