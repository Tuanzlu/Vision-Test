...
import com.baidu.idl.main.facesdk.paymentlibrary.utils.PreferencesManager;
...
public class PaymentSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.gate_settting_back) {
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, PaymentMinFaceActivity.class);
            startActivity(intent);
        } else if (id == R.id.gate_config_qualtify) {
            Intent intent = new Intent(PaymentSettingActivity.this, PaymentConfigQualtifyActivity.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, PaymentFaceDetectActivity.class);
            startActivity(intent);
        } else if (id == R.id.gate_lens_settings) {
            Intent intent = new Intent(PaymentSettingActivity.this, PaymentLensSettingsActivity.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, PaymentPictureOptimizationActivity.class);
            startActivity(intent);
        } else if (id == R.id.gate_log_settings) {
            Intent intent = new Intent(PaymentSettingActivity.this, PaymentLogSettingActivity.class);
            startActivity(intent);
        }
    }
}