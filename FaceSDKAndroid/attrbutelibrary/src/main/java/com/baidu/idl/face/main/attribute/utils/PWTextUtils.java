...
public class PWTextUtils {
    ...
    public static void showDescribeText(View target, View reference, Context context,
        ...
        popupWindow.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.attribute_cw_round));
        TextView textView = pView.findViewById(R.id.showText);
        textView.setText(text);
        popupWindow.setContentView(pView);
        popupWindow.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.attribute_sr_pw_rectangle));
